...
namespace GNRS.ModuloPresupuesto.BL.BC
{
    public class PresupuestoPersonalProyectadoBC
    {
        ...
        public List<PersonaBE> listarPersonalProyectado(Int32 idCategoria, String estado, Int32 idLocalidad, Int32 idArea, Int32 idSeccion, Int32 id_periodo_presupuesto)
        {
            return personaDALC.listarPersonasProyectadas(idCategoria, estado, idLocalidad, idArea, idSeccion,id_periodo_presupuesto);
        }
        ...
        public List<PersonalProyectadoBE> listarPersonalProyectadoBEXEstado(string estado, int id_periodo_presupuesto)
        {
            try
            {
                List<PERSONA> listaPersona = personaDALC.listarPersonasXEstado(estado, id_periodo_presupuesto);
        ...
        public void EnviarCorreo(string strBody, string strSubject)
        {
            ...
            string strFrom = "sistema.sgdt@gmail.com";
            string pass = "sistematp";
        ...
        public List<PersonalProyectadoBE> listarPersonalProyectadoBEAprobacion(String estado, Int32 categoria, Int32 localidad, Int32 area, Int32 seccion, Int32 id_periodo_presupuesto)
        {
            try
            {
                
                List<PersonalProyectadoBE> listaPersonalProyectadoTemp = new List<PersonalProyectadoBE>();
                listaPersonalProyectadoTemp = personaDALC.listarPersonalProyectadoBE(categoria, estado, localidad, area, seccion, id_periodo_presupuesto);
         ...
         {
             return personaDALC.eliminarPersonalProyectado(id_persona);
         }
