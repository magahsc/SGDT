...
namespace GNRS.ModuloPresupuesto.UI
{
    public partial class SolicitudAprobacion : System.Web.UI.Page
    {
        ...
        public void cargarPersonalProyectado()
        {
            ...
            listaPersonalProyectadoBE = objPresupPersonalProyectadoBC.listarPersonalProyectadoBEXEstado("P", idPeriodo);
        ...
        protected void SolicitarAprobacionButton_Click(object sender, EventArgs e)
        {
            ...
            if (listaIdPersonal.Count() > 0)
            {
                ...
                string asunto = "Solicitud de pre aprobacion";
        ...
        protected void cargarGrillaPersonal()
        {
            try {
                ...
                objPresupPersonalProyectadoBC = new PresupuestoPersonalProyectadoBC();
                List<PersonalProyectadoBE> listaPersonalProyectadoBE = new List<PersonalProyectadoBE>();
                listaPersonalProyectadoBE = objPresupPersonalProyectadoBC.listarPersonalProyectadoBEAprobacion("P", Convert.ToInt32(ddlCategoria.SelectedValue), Convert.ToInt32(ddlLocalidad.SelectedValue), Convert.ToInt32(ddlArea.SelectedValue), Convert.ToInt32(ddlSeccion.SelectedValue), idPeriodo);
                PersonalProyectadoGridView.DataSource = listaPersonalProyectadoBE;
                PersonalProyectadoGridView.DataBind();
                GridUpdatePanel.Update();
            }
