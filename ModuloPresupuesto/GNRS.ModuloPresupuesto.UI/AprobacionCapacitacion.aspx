<%@ Page Title="" Language="C#" MasterPageFile="~/ModuloPresupuesto.Master" AutoEventWireup="true" CodeBehind="AprobacionCapacitacion.aspx.cs" Inherits="GNRS.ModuloPresupuesto.UI.AprobacionCapacitacion" %>
...
<link rel="stylesheet" href="http://code.jquery.com/ui/1.10.2/themes/smoothness/jquery-ui.css" />
  ...
  <script>
      ...
      function mostrarAspxAsPopUpMotivo(id) {
          ...
          var url = 'DetalleMotivoPresupuestoCapacitacion.aspx?modo=motivo&id=' + id + '&estado=PA';
   ...
   <div id="dialog-message" title="Modulo de Presupuesto">  </div>
    ...
    <asp:LinkButton ID="CapacitacionesProcesadasLinkButton" runat="server" 
       >Capacitaciones procesadas</asp:LinkButton>
    &nbsp;
                   ...
                   <asp:BoundField HeaderText="Inicio" DataField="MesInicio" 
                    ...
                    <asp:BoundField HeaderText="Área" DataField="NombreArea" 
                     ...
                     <asp:TemplateField HeaderText="Pre aprobado" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <asp:Button ID="PreaprobadoButton" runat="server" Text="+" CommandName="cmdMotivo" CommandArgument='<%# Eval("idCapacitacion_Proyectada") %>' />
                                            </ItemTemplate>
                                    </asp:TemplateField>
       ...
       <ContentTemplate> 
        <Table ID="Table3" runat="server">
         <tbody>
          ...
          <tr>
             <td><asp:Label ID="MensajeLabel" runat="server" Text="" Width="900"></asp:Label></td>
             
              <td><asp:Button ID="AprobarButton" runat="server" Text="Aprobar" 
        Width="140px" onclick="AprobarButton_Click"   /></td>

         <td><asp:Button ID="RechazarButton" runat="server" Text="Rechazar" 
        Width="140px" onclick="RechazarButton_Click"   /></td>
