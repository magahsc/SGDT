...
namespace GNRS.ModuloPresupuesto.UI
{
    public partial class RegistrarPresupuestoPersonalProyectado : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (modo.Equals("1"))
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    rowidentificador.Visible = false;
            ...
            if (modo.Equals("2"))
            {
                if (!IsPostBack)
                {
                    ...
                    string id_persona = Request.QueryString["id"];

                    if (id_persona != null)
                    {
                        codigoEditarHidden.Attributes["value"] = id_persona;
                        PERSONA objPersona = new PERSONA();
                        objPersona = objPersonaDALC.obtenerPersonasXId(Convert.ToInt32( id_persona));
        ...
        public void cargarPersonaAEditar(PERSONA objPersona)
        {
            ...
            rowidentificador.Visible = true;
            guardarButton.Visible = true;
            registrarButton.Visible = false;
            rowCantidad.Visible = false;
        ...
        protected void volverButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ListarPresupuestoPersonal.aspx");
        }
