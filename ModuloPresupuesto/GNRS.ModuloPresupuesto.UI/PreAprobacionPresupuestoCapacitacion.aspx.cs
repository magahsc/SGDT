...
{
    public partial class PreAprobacionPresupuestoCapacitacion : System.Web.UI.Page
    { 
        ...
        public void ListarPresupuestos()
        {
            ...
            lista = objcapacitar.ListaCapacitacionesParaAprobar(objAprobar,"EP");
        ...
        protected void AprobarButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in ListasCapacitacionesAprobacionGridView.Rows)
            {
                ...
                if (check.Checked)
                {
                    ...
                    objPresupuesto.presupuesto_aprobado = "PA";
            ...
            if (entrar == true)
            {
                ...
                string asunto = "Solicitud de Preaprobación";
