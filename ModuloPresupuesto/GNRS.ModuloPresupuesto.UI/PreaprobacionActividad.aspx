<%@ Page Title="" Language="C#" MasterPageFile="~/ModuloPresupuesto.Master" AutoEventWireup="true" CodeBehind="PreaprobacionActividad.aspx.cs" Inherits="GNRS.ModuloPresupuesto.UI.PreaprobacionActividad" %>
    ...
    <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" CssClass="panel" >
        ...
        <asp:UpdatePanel ID="GridUpdatePanel" runat="server" UpdateMode="Conditional"> 
         <ContentTemplate>  
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <label class="link_inactivo">Pre aprobaci&oacute;n</label>
                &nbsp;&nbsp;&nbsp;&nbsp;                
