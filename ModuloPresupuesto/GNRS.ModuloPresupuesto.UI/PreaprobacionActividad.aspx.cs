...
{
    public partial class PreaprobacionActividad : System.Web.UI.Page
    {
        ...
        public void cargarActividadProyectada()
        {
            ...
            listarActividadProyectada = objActividadProyectadaBC.listarActividadProyectadaXEstado("EP", idPeriodo, Convert.ToInt32(ddlAnioInicio.SelectedValue), Convert.ToInt32(ddlAnioFin.SelectedValue), Convert.ToInt32(ddlMesInicio.SelectedValue), Convert.ToInt32(ddlMesFin.SelectedValue));
        ...
        protected void AprobarButton_Click(object sender, EventArgs e)
        {
            ...
            {
                objActividadProyectadaBC.AprobarPreAprobacion_Actividad(listaIdActividad, listMotivos);
                cargarActividadProyectada();
                ...
                string body = "<p>Estimado(a)," +
                        "<br />" +
                        "Se le informa que se ha realizado una solicitud de aprobacion de  presupuesto de actividad, ingresa al <br />sistema para mayor detalle. " +
                        "Recomendamos realizar las acciones pertinentes." +
                        "<br /><br />Gracias," +
                        "<br />Administrador del Sistema</p>";

                string asunto = "Solicitud de aprobacion de actividad";
